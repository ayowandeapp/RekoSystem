...
<nav class="navbar">
    <div class="container">
        ...
        <br><br>       
        <a href="<?php url(''); ?>" class="btn btn-info float-right ml-auto">Go Back</a>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <form  action="<?php url('product/add_product/'.$user_id); ?>"  method="post" name="form" id="form1" class="form-horizontal">
